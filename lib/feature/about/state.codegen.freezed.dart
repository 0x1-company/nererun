...
class _$AboutStateImpl extends _AboutState {
  _$AboutStateImpl({required this.packageVersion}) : super._();
  ...
  @override
  int get hashCode => Object.hash(runtimeType, packageVersion);
...
abstract class _AboutState extends AboutState {
  factory _AboutState({required final Version packageVersion}) =
      _$AboutStateImpl;
